...
public class Pedido {
	 ...
	 * Contém um cabeçalho com sua data e depois, em cada linha, a descrição de cada
	 * produto.
	 * Ao final, mostra o valor a ser pago pelo pedido.
	 * 
	 * @return Uma string contendo dados do pedido conforme especificado (cabeçalho,
	 *         detalhes, valor a pagar)
	 */
    @Override
