...
public class App {
    ...
    */
    static int menu() {
        ...
        System.out.println("9 - Exibir o histórico completo de pedidos de um cliente");
        System.out.println("10 - Filtrar os pedidos de um cliente por valor mínimo");
        System.out.println("11 - Exibir o ranking de clientes");
        // - adicione aqui as opções de menu referentes às Tarefas 4 e 5:
     ...
     */
    static <K> AVL<Integer, Cliente> lerClientes(String nomeArquivoDados,  Function<Cliente, K> extratorDeChave) {
        ...
        try {
    		...
    		for (int i = 0; i < numCliente; i++) {
    			...
    			clientesCadastrados.inserir(chave.hashCode(), cliente);
    		}
    ...
    static <K> Cliente localizarCliente(ABB<K, Cliente> clienteCadastrados, K procurado) {
    	...
    	try {
    		cliente = clienteCadastrados.pesquisar(procurado);
    	} catch (NoSuchElementException excecao) {
    		cliente = null;
    	}
    	
    	System.out.println("Número de comparações realizadas: " + clienteCadastrados.getComparacoes());
    	System.out.println("Tempo de processamento da pesquisa: " + clienteCadastrados.getTempo() + " ms");
    ...
    static Produto localizarProdutoNome(ABB<String, Produto> produtosCadastrados) {
     ...
     static Cliente localizarClienteID(ABB<Integer,Cliente> clienteCadastrados) {
        
        int idCliente = lerOpcao("Digite o identificador do cliente desejado: ", Integer.class);
        
        return localizarCliente(clienteCadastrados, idCliente);
    }
    ...
    public static void pedidosDoCliente() {
        ...
        Lista<Pedido> pedidosDoCliente;
    	Cliente cliente = localizarClienteID(clientesPorId);
    	String nomeArquivo = "DocumentoCliente" + cliente.hashCode() + ".txt";  
    ...
    public static void rankingClientes() {
        ...
        for (int i = 0; i < pedidosPorCliente.tamanho(); i++) {
            int qtdPedido = pedidosPorCliente.tabelaHash[i].tamanho();
            if (qtdPedido >= 2){
                System.out.println(pedidosPorCliente.tabelaHash[i].toString());
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        clientesPorId = lerClientes(nomeArquivoDados, (c -> c.hashCode()));
        ...
        do{
        	...
        	// adicione aqui os cases correspondentes às novas opções do menu (Tarefas 4 e 5),
