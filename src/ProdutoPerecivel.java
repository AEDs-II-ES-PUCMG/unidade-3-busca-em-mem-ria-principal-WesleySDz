...
public class ProdutoPerecivel extends Produto {
	 ...
	 * @param validade    Data de validade do produto, que deve ser posterior à data
	 *                    atual.
	 * @throws IllegalArgumentException em caso dos limites acima serem
	 *                                  desrespeitados.
	 */
	...
	/**
	 * Construtor do produto com margem de lucro padrão (20%). Causa exceção em caso
	 * de valores inválidos para os dados do produto.
	 * 
	 * @param desc       Descrição do produto (mínimo de 3 caracteres)
	 * @param precoCusto Preço de compra do produto (mínimo 0.01)
	 * @param validade   Data de validade do produto, que deve ser posterior à data
	 ...
	 * de lucro e
	 * dias de validade. Se o prazo de validade estiver a menos de 7 dias, será
	 ...
	 * lucro são formatados com 2 casas decimais.
